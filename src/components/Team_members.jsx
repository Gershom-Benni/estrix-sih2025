  ...
  return (
    <>
        ...
        <div className={styles.card_container}>
            <Team_member_card img_path="prem image.jpg" name="Bagya Prem K" role="Team Leader and Hardware"></Team_member_card>
            <Team_member_card img_path="Gershom image.jpg" name="Gershom Benni P" role="Software"></Team_member_card>
